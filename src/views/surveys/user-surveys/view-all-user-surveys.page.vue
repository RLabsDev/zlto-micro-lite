...
<template>
     <q-tabs
        ...
        >
          <q-tab icon="bi-arrow-clockwise" name="mails" label="My In Progress Surveys" />
          <q-tab icon="bi-check-circle" name="alarms" label="My Completed Surveys" />
        </q-tabs>
    ...
    <q-card class="my-card" v-for="(item, index) in items" :key="index">
      <q-card-section>
        <div class="row items-center no-wrap">
          ...
          <div class="col">
        <div class="text-h6">In Progress Survey {{item}}</div>
      ...
      <q-card-section>
        <div class="row items-center no-wrap">
          ...
          <div class="col">
        <div class="text-h6">Completed Survey {{item}}</div>
        <div class="text-subtitle2">Survey Description</div> 
        </div>
        <div class="col-auto">
          <q-btn color="grey-7" round flat icon="bi-chevron-right" @click=""></q-btn>
